...
public class Tokens {
  ...
  //tokenize meaning: break text into individual lingustic units
    ...
    */
      myTokens = new StringTokenizer(line,","); //is used to tokenize the string to extract out each token/word, the second parameter represents the delimiter
    ...
    */
      ...
      while (myTokens.hasMoreTokens()) {
         animals[i]=myTokens.nextToken(); //retrun the next word
         i++;
      }
    /*
     * Print the array
